...
namespace Mickey.GL
{
    class GameGrid
    {
        ...
        public void ReplaceQuestWithKey()
        {
                ...
                for (int row = 0; row < this.rows; row++)
                {
                    for (int col = 0; col < this.cols; col++)
                    {
                        ...
                        if (cell.CurrentGameObject.GameObjectType == GameObjectType.Quest)
                        {
                            cell.setGameObject(new GameObject(GameObjectType.Key, Game.getGameObjectImage('K')));
                        }
                    }
                }
